...
export default function Regions({ regions, filters, stats }) {
    ...
    const submit = () => {
        if (modal === 'create') {
            router.post(route('admin.regions.store'), form, { onSuccess: () => setModal(null) });
        } else {
            router.put(route('admin.regions.update', modal.id), form, { onSuccess: () => setModal(null) });
        }
    };
                            ...
                            <tr key={r.id} className="hover:bg-gray-50">
                                ...
                                <td className="px-4 py-3 text-right">
                                    <div className="flex items-center justify-end gap-2">
                                        ...
                                        <button onClick={() => del(r.id)} className="p-1.5 text-gray-400 hover:text-red-600 rounded">
