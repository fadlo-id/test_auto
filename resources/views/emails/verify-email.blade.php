<!DOCTYPE html>
<html lang="fr">
<head><meta charset="UTF-8"><title>Verifiez votre email</title></head>
...
<div style="max-width:560px;margin:0 auto;background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 1px 3px rgba(0,0,0,.1)">
    ...
    <div style="padding:32px">
        <h2 style="color:#111827;margin-top:0">Verifiez votre adresse email</h2>
        <p style="color:#374151">Bonjour {{ $userName }},</p>
        <p style="color:#374151">
            Merci de votre inscription sur AutoEcoles.ma. Cliquez sur le bouton ci-dessous pour confirmer votre adresse email.
        </p>
        ...
        <p style="color:#6b7280;font-size:14px">
            Ce lien expire dans 60 minutes. Si vous n'avez pas cree de compte, vous pouvez ignorer cet email.
        </p>
    </div>
