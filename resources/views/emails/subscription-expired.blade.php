<!DOCTYPE html>
<html lang="fr">
<head><meta charset="UTF-8"><title>Abonnement expire</title></head>
...
<div style="max-width:560px;margin:0 auto;background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 1px 3px rgba(0,0,0,.1)">
    ...
    <div style="padding:32px">
        <h2 style="color:#111827;margin-top:0">Votre abonnement a expire</h2>
        <p style="color:#374151">Bonjour,</p>
        <p style="color:#374151">
            Votre abonnement <strong>{{ $subscription->plan?->name }}</strong> pour
            <strong>{{ $subscription->autoSchool?->name }}</strong> a expire.
            Votre profil reste visible mais sans les avantages premium.
        </p>
        <p style="color:#374151">Renouvelez votre abonnement pour retrouver toutes vos fonctionnalites.</p>
