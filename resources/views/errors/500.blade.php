...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        h1 { font-size: 5rem; font-weight: 800; color: #ef4444; line-height: 1; margin-bottom: .5rem; }
        h2 { font-size: 1.25rem; font-weight: 600; margin-bottom: .75rem; }
        p { color: #6b7280; margin-bottom: 2rem; }
        a { display: inline-block; background: #ea580c; color: white; padding: .75rem 1.5rem; border-radius: .75rem; text-decoration: none; font-weight: 500; transition: background .2s; }
...
<body>
    <div class="card">
        ...
        <p>Une erreur inattendue s'est produite. Notre équipe a été notifiée. Veuillez réessayer dans quelques instants.</p>
